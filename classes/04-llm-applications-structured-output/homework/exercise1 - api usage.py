...
def classify_sentiment(review: str) -> Literal["Positive", "Neutral", "Negative"]:
    ### YOUR CODE HERE ###
    raise NotImplementedError("classify_sentiment not implemented")
...
def classify_email(
    ...
    ### YOUR CODE HERE ###
    raise NotImplementedError("classify_email not implemented")


def filter_message(input_message: str) -> Literal["allowed", "filtered"]:
    ### YOUR CODE HERE ###
    raise NotImplementedError("filter_message not implemented")
